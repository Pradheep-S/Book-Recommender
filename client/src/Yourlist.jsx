    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(`https://bookrecc-api.vercel.app/api/userdata/${username}`);
                if (!response.ok) {
                ...
                const recommendationResponse = await fetch(`https://bookrecc-api.vercel.app/api/recommendations/${username}`);
